...
public class BoundedServiceActivity extends AppCompatActivity {
    ...
    private GetMessageFromServiceButtonListener getMlistener = new GetMessageFromServiceButtonListener();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getMessageFromServiceButton.setOnClickListener(getMlistener);
    }
